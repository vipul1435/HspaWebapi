    ...
    public partial class PropertyAdded : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FunrnishedTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SellOrRent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Bhk = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PropertyTypeId = table.Column<int>(type: "int", nullable: false),
                    FunrnishedTypeId = table.Column<int>(type: "int", nullable: false),
                    ...
                    ReadyToMove = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AvailableFrom = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AgeOfProperty = table.Column<int>(type: "int", nullable: false),
                    GatedCommunity = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MainEntrance = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_FunrnishedTypeId",
                table: "Properties",
